...
namespace economy_factory {
	...
	float factory_desired_raw_profit(dcon::factory_id f, float spendings);
	...
	void add_factory_level_to_state(sys::state& state, dcon::state_instance_id sid, dcon::factory_type_id ft, bool is_upgrade);
