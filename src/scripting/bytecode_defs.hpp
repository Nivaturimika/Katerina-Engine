...
//
// step 2. replace with:
// "TRIGGER_SCOPE_BYTECODE_ELEMENT($1, $3) \"
//
// step3 3. fixup

// SCRIPTING PAYLOAD SIZES
//
...
#define EFFECT_BYTECODE_LIST \
	...
	EFFECT_BYTECODE_ELEMENT(0x01BF, trigger_crisis, 0) \
	EFFECT_BYTECODE_ELEMENT(0x01C0, set_crisis_type, 1) \
	EFFECT_BYTECODE_ELEMENT(0x01C1, set_crisis_colony, 1) \
	EFFECT_BYTECODE_ELEMENT(0x01C2, set_crisis_colony_this, 0) \
...
#define EFFECT_SCOPE_BYTECODE_LIST \
	...
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_neighbor_province_scope, 0x0001) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_neighbor_country_scope, 0x0002) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_country_scope, 0x0003) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_country_scope_nation, 0x0004) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_empty_neighbor_province_scope, 0x0005) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_greater_power_scope, 0x0006) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(poor_strata_scope_nation, 0x0007) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(poor_strata_scope_state, 0x0008) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(poor_strata_scope_province, 0x0009) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(middle_strata_scope_nation, 0x000A) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(middle_strata_scope_state, 0x000B) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(middle_strata_scope_province, 0x000C) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(rich_strata_scope_nation, 0x000D) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(rich_strata_scope_state, 0x000E) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(rich_strata_scope_province, 0x000F) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_pop_scope_nation, 0x0010) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_pop_scope_state, 0x0011) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_pop_scope_province, 0x0012) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_owned_scope_nation, 0x0013) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_owned_scope_state, 0x0014) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_core_scope, 0x0015) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_state_scope, 0x0016) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(random_list_scope, 0x0017) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(random_scope, 0x0018) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(owner_scope_state, 0x0019) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(owner_scope_province, 0x001A) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(controller_scope, 0x001B) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(location_scope, 0x001C) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(country_scope_pop, 0x001D) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(country_scope_state, 0x001E) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(capital_scope, 0x001F) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(this_scope_nation, 0x0020) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(this_scope_state, 0x0021) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(this_scope_province, 0x0022) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(this_scope_pop, 0x0023) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(from_scope_nation, 0x0024) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(from_scope_state, 0x0025) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(from_scope_province, 0x0026) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(from_scope_pop, 0x0027) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(sea_zone_scope, 0x0028) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(cultural_union_scope, 0x0029) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(overlord_scope, 0x002A) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(sphere_owner_scope, 0x002B) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(independence_scope, 0x002C) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(flashpoint_tag_scope, 0x002D) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(crisis_state_scope, 0x002E) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(state_scope_pop, 0x002F) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(state_scope_province, 0x0030) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_substate_scope, 0x0031) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(capital_scope_province, 0x0032) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_core_scope_province, 0x0033) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(tag_scope, 0x0034) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(integer_scope, 0x0035) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(pop_type_scope_nation, 0x0036) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(pop_type_scope_state, 0x0037) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(pop_type_scope_province, 0x0038) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(region_proper_scope, 0x0039) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(region_scope, 0x003A) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(if_scope, 0x003B) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(else_if_scope, 0x003C) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_event_country_scope, 0x003D) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_decision_country_scope, 0x003E) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_event_country_scope_nation, 0x003F) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(x_decision_country_scope_nation, 0x0040) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(from_bounce_scope, 0x0041) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(this_bounce_scope, 0x0042) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(random_by_modifier_scope, 0x0043) \
	EFFECT_SCOPE_BYTECODE_ELEMENT(loop_bounded_scope, 0x0044) \
...
#define TRIGGER_BYTECODE_LIST \
	...
	TRIGGER_BYTECODE_ELEMENT(0x02E3, tags_eq, 5) \
	TRIGGER_BYTECODE_ELEMENT(0x02E4, strings_eq, 6) \
	TRIGGER_BYTECODE_ELEMENT(0x02E5, values_eq, 6) \
	TRIGGER_BYTECODE_ELEMENT(0x02E6, dates_eq, 6) \
	TRIGGER_BYTECODE_ELEMENT(0x02E7, tags_match, 8) \
	TRIGGER_BYTECODE_ELEMENT(0x02E8, strings_match, 8) \
	TRIGGER_BYTECODE_ELEMENT(0x02E9, values_match, 8) \
	TRIGGER_BYTECODE_ELEMENT(0x02EA, dates_match, 8) \
	TRIGGER_BYTECODE_ELEMENT(0x02EB, tags_contains, 3) \
	TRIGGER_BYTECODE_ELEMENT(0x02EC, strings_contains, 4) \
	TRIGGER_BYTECODE_ELEMENT(0x02ED, values_contains, 4) \
	TRIGGER_BYTECODE_ELEMENT(0x02EE, dates_contains, 4) \
	TRIGGER_BYTECODE_ELEMENT(0x02EF, length_greater_tags, 4) \
...
#define TRIGGER_SCOPE_BYTECODE_LIST \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(generic_scope, 0x0000) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_neighbor_province_scope, 0x0001) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_neighbor_country_scope_nation, 0x0002) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_neighbor_country_scope_pop, 0x0003) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_war_countries_scope_nation, 0x0004) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_war_countries_scope_pop, 0x0005) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_greater_power_scope, 0x0006) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_owned_province_scope_state, 0x0007) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_owned_province_scope_nation, 0x0008) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_core_scope_province, 0x0009) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_core_scope_nation, 0x000A) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_state_scope, 0x000B) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_substate_scope, 0x000C) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_sphere_member_scope, 0x000D) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_pop_scope_province, 0x000E) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_pop_scope_state, 0x000F) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_pop_scope_nation, 0x0010) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_provinces_in_variable_region, 0x0011) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(owner_scope_state, 0x0012) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(owner_scope_province, 0x0013) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(controller_scope, 0x0014) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(location_scope, 0x0015) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(country_scope_state, 0x0016) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(country_scope_pop, 0x0017) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(capital_scope, 0x0018) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(this_scope_pop, 0x0019) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(this_scope_nation, 0x001A) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(this_scope_state, 0x001B) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(this_scope_province, 0x001C) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(from_scope_pop, 0x001D) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(from_scope_nation, 0x001E) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(from_scope_state, 0x001F) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(from_scope_province, 0x0020) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(sea_zone_scope, 0x0021) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(cultural_union_scope, 0x0022) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(overlord_scope, 0x0023) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(sphere_owner_scope, 0x0024) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(independence_scope, 0x0025) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(flashpoint_tag_scope, 0x0026) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(crisis_state_scope, 0x0027) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(state_scope_pop, 0x0028) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(state_scope_province, 0x0029) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(tag_scope, 0x002A) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(integer_scope, 0x002B) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(country_scope_nation, 0x002C) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(country_scope_province, 0x002D) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(cultural_union_scope_pop, 0x002E) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(capital_scope_province, 0x002F) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(capital_scope_pop, 0x0030) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_country_scope, 0x0031) \
	TRIGGER_SCOPE_BYTECODE_ELEMENT(x_neighbor_province_scope_state, 0x0032) \
