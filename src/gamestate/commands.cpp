...
void execute_toggle_auto_assign_single_leader(sys::state& state, dcon::nation_id source, dcon::leader_id id) {
	state.world.leader_set_auto_assign(id, !state.world.leader_get_auto_assign(id));
}
