...
namespace parsers {
	...
	struct scenario_building_context {
		...
		ankerl::unordered_dense::map<std::string, dcon::commodity_group_id> map_of_commodity_group_names;
	...
	struct unit_definition : public military::unit_definition {
		...
		void sprite(association_type, std::string_view value, error_handler& err, int32_t line, scenario_building_context& context);
		void finish(scenario_building_context&);
	};
	...
	struct country_file {
		...
		void graphical_culture(association_type, std::string_view value, error_handler& err, int32_t line, country_file_context& context);
	...
	struct decision {
		...
		void news_title(association_type, std::string_view value, error_handler& err, int32_t line, decision_context& context);
		void news_desc_long(association_type, std::string_view value, error_handler& err, int32_t line, decision_context& context);
		void news_desc_medium(association_type, std::string_view value, error_handler& err, int32_t line, decision_context& context);
		void news_desc_short(association_type, std::string_view value, error_handler& err, int32_t line, decision_context& context);
		void news_picture(association_type, std::string_view value, error_handler& err, int32_t line, decision_context& context);
	};
	...
	struct generic_event {
		...
		dcon::text_key desc_;
		dcon::gfx_object_id news_picture_;
		dcon::text_key news_title_;
		dcon::text_key news_long_desc_;
		dcon::text_key news_medium_desc_;
		dcon::text_key news_short_desc_;
		...
		void news_title(association_type, std::string_view value, error_handler& err, int32_t line, event_building_context& context);
		void news_desc_long(association_type, std::string_view value, error_handler& err, int32_t line, event_building_context& context);
