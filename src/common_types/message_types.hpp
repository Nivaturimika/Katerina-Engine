...
namespace sys {
	...
	constexpr inline uint8_t default_self_message_settings[int32_t(sys::message_setting_type::count)] = {
	...
	constexpr inline uint8_t default_interesting_message_settings[int32_t(sys::message_setting_type::count)] = {
	...
	constexpr inline uint8_t default_other_message_settings[int32_t(sys::message_setting_type::count)] = {
