...
- **Version**: 0.1.0
- **Scopes**: Any
- **Comments**: See extensions.md for full usage explaination
...
- **Version**: 0.1.0
- **Scopes**: Any
- **Comments**: Evaluates a scripted trigger from `scripted triggers/`, see `extensions.md` for more usage info
