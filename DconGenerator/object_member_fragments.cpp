		...
		switch(prop.type) {
			...
			case property_type::vectorizable:
				if(add_prefix) {
					...
					o + "#ifndef DCON_NO_VE";
					o + "ve::value_to_vector_type<@base_type@> @obj@_get_@prop@(@vector_position@<@obj@_id> id) const" + block{
						o + "return ve::apply([t = this](@obj@_id i){ return t->@obj@_get_@prop@(i); }, id);";
					};
					o + "ve::value_to_vector_type<@base_type@> @obj@_get_@prop@(ve::partial_contiguous_tags<@obj@_id> id) const" + block{
						o + "return ve::apply([t = this](@obj@_id i){ return t->@obj@_get_@prop@(i); }, id);";
					};
					o + "ve::value_to_vector_type<@base_type@> @obj@_get_@prop@(ve::tagged_vector<@obj@_id> id) const" + block{
						o + "return ve::apply([t = this](@obj@_id i){ return t->@obj@_get_@prop@(i); }, id);";
					};
					o + "#endif";
				} else {
		...
		switch(prop.type) {
			...
			case property_type::vectorizable:
				if(add_prefix) {
					...
					o + "#ifndef DCON_NO_VE";
					o + "DCON_RELEASE_INLINE ve::value_to_vector_type<@base_type@> @obj@_get_@prop@(@vector_position@<@obj@_id> id) const noexcept" + block{
						o + "return ve::load(id, @obj@.m_@prop@.vptr());";
					};
					o + "DCON_RELEASE_INLINE ve::value_to_vector_type<@base_type@> @obj@_get_@prop@(ve::partial_contiguous_tags<@obj@_id> id) const noexcept" + block{
						o + "return ve::load(id, @obj@.m_@prop@.vptr());";
					};
					o + "DCON_RELEASE_INLINE ve::value_to_vector_type<@base_type@> @obj@_get_@prop@(ve::tagged_vector<@obj@_id> id) const noexcept" + block{
						o + "return ve::load(id, @obj@.m_@prop@.vptr());";
					};
					o + "#endif";
				} else {
	...
	if(!const_mode) {
		if(prop.hook_set) {
			switch(prop.type) {  // HOOKED SETTERS
				...
				case property_type::vectorizable:
					if(add_prefix) {
						o + "void @obj@_set_@prop@(@obj@_id id, @base_type@ value);";

						if(prop.protection == protection_type::read_only || prop.protection == protection_type::hidden)
							o + "friend void @obj@_fat_id::set_@prop@(@base_type@) const;";

						o + "#ifndef DCON_NO_VE";
						o + "void @obj@_set_@prop@(@vector_position@<@obj@_id> id, ve::value_to_vector_type<@base_type@> value)" + block{
							o + "ve::apply(value, [t = this](@obj@_id i, @base_type@ v){ t->@obj@_set_@prop@(i, v); }, id);";
						};
						o + "void @obj@_set_@prop@(ve::partial_contiguous_tags<@obj@_id> id, ve::value_to_vector_type<@base_type@> value)" + block{
							o + "ve::apply(value, [t = this](@obj@_id i, @base_type@ v){ t->@obj@_set_@prop@(i, v); }, id);";
						};
						o + "void @obj@_set_@prop@(ve::tagged_vector<@obj@_id> id, ve::value_to_vector_type<@base_type@> value)" + block{
							o + "ve::apply(value, [t = this](@obj@_id i, @base_type@ v){ t->@obj@_set_@prop@(i, v); }, id);";
						};
						o + "#endif";
					} else {
						o + "DCON_RELEASE_INLINE void @namesp@set_@prop@(@base_type@ v) const" + block{
							o + "container.@obj@_set_@prop@(id, v);";
						};
					}
					break;
				...
				case property_type::array_vectorizable:
					if(add_prefix) {
						o + "void @obj@_set_@prop@(@obj@_id id, @index_type@ n, @base_type@ value);";
						o + "void @namesp@resize_@prop@(uint32_t sz) const;";

						if(prop.protection == protection_type::read_only || prop.protection == protection_type::hidden) {
							o + "friend void @obj@_fat_id::set_@prop@(@index_type@, @base_type@) const;";
							o + "friend void @obj@_fat_id::resize_@prop@(uint32_t) const noexcept;";
						}

						o + "#ifndef DCON_NO_VE";
						o + "void @obj@_set_@prop@(@vector_position@<@obj@_id> id, @index_type@ n, ve::value_to_vector_type<@base_type@> value)" + block{
							o + "ve::apply(value, [t = this, n](@obj@_id i, @type@ v){ t->@obj@_set_@prop@(i, n, v); }, id);";
						};
						o + "void @obj@_set_@prop@(ve::partial_contiguous_tags<@obj@_id> id, @index_type@ n, ve::value_to_vector_type<@base_type@> value)" + block{
							o + "ve::apply(value, [t = this, n](@obj@_id i, @type@ v){ t->@obj@_set_@prop@(i, n, v); }, id);";
						};
						o + "void @obj@_set_@prop@(ve::tagged_vector<@obj@_id> id, @index_type@ n, ve::value_to_vector_type<@base_type@> value)" + block{
							o + "ve::apply(value, [t = this, n](@obj@_id i, @type@ v){ t->@obj@_set_@prop@(i, n, v); }, id);";
						};
						o + "#endif";
					} else {
						o + "DCON_RELEASE_INLINE void @namesp@set_@prop@(@index_type@ i, @base_type@ v) const" + block{
							o + "container.@obj@_set_@prop@(id, i, v);";
						};
						o + "DCON_RELEASE_INLINE void @namesp@resize_@prop@(uint32_t sz) const noexcept" + block{
							o + "container.@obj@_resize_@prop@(sz);";
			...
			switch(prop.type) {
				...
				case property_type::vectorizable:
					if(add_prefix) {
						...
						if(prop.protection == protection_type::read_only || prop.protection == protection_type::hidden) {
							o + "friend void @obj@_fat_id::set_@prop@(@base_type@) const noexcept;";
						}

						o + "#ifndef DCON_NO_VE";
						o + "DCON_RELEASE_INLINE void @obj@_set_@prop@(@vector_position@<@obj@_id> id, ve::value_to_vector_type<@base_type@> values) noexcept" + block{
							o + "ve::store(id, @obj@.m_@prop@.vptr(), values);";
						};
						o + "DCON_RELEASE_INLINE void @obj@_set_@prop@(ve::partial_contiguous_tags<@obj@_id> id, ve::value_to_vector_type<@base_type@> values) noexcept" + block{
							o + "ve::store(id, @obj@.m_@prop@.vptr(), values);";
						};
						o + "DCON_RELEASE_INLINE void @obj@_set_@prop@(ve::tagged_vector<@obj@_id> id, ve::value_to_vector_type<@base_type@> values) noexcept" + block{
							o + "ve::store(id, @obj@.m_@prop@.vptr(), values);";
						};
						o + "#endif";
					} else {
						o + "DCON_RELEASE_INLINE void @namesp@set_@prop@(@base_type@ v) const noexcept" + block{
							o + "container.@obj@_set_@prop@(id, v);";
						};
					}
					break;
				...
				case property_type::array_vectorizable:
					if(add_prefix) {
						...
						if(prop.protection == protection_type::read_only || prop.protection == protection_type::hidden) {
							o + "friend void @obj@_fat_id::set_@prop@(@index_type@, @base_type@) const noexcept;";
							o + "friend void @obj@_fat_id::@prop@_resize(uint32_t) const noexcept;";
						}

						o + "#ifndef DCON_NO_VE";
						o + "DCON_RELEASE_INLINE void @obj@_set_@prop@(@vector_position@<@obj@_id> id, @index_type@ n, ve::value_to_vector_type<@base_type@> values) noexcept" + block{
							o + "ve::store(id, @obj@.m_@prop@.vptr(dcon::get_index(n)), values);";
						};
						o + "DCON_RELEASE_INLINE void @obj@_set_@prop@(ve::partial_contiguous_tags<@obj@_id> id, @index_type@ n, ve::value_to_vector_type<@base_type@> values) noexcept" + block{
							o + "ve::store(id, @obj@.m_@prop@.vptr(dcon::get_index(n)), values);";
						};
						o + "DCON_RELEASE_INLINE void @obj@_set_@prop@(ve::tagged_vector<@obj@_id> id, @index_type@ n, ve::value_to_vector_type<@base_type@> values) noexcept" + block{
							o + "ve::store(id, @obj@.m_@prop@.vptr(dcon::get_index(n)), values);";
						};
						o + "#endif";
					} else {
						o + "DCON_RELEASE_INLINE void @namesp@set_@prop@(@index_type@ i, @base_type@ v) const noexcept" + block{
							o + "container.@obj@_set_@prop@(id, i, v);"; 
						};
						o + "DCON_RELEASE_INLINE void @namesp@resize_@prop@(uint32_t sz) const noexcept" + block{
							o + "container.@obj@_resize_@prop@(sz);";
				...
				if(ir.related_to != &obj) {
					...
					if(ir.protection != protection_type::read_only && ir.protection != protection_type::hidden) {
						if(add_prefix) {
							...
							} else if(ir.is_primary_key) {
								o + substitute{ "r_as_name", ir.type_name };
								o + "void @obj@_set_@r_prop@_from_@rel@(@obj@_id id, @r_type@_id val)" + block{
									o + "@rel@_set_@as_name@(@rel@_id(@rel@_id::value_base_t(val.index())), id);";
								};
							}
						} else if(!const_mode) {
							if (in_rel.linked_as->is_primary_key || ir.is_primary_key) {
